...
public class EmployeeUI extends JFrame {
	...
	public EmployeeUI() {
		...
		setTitle("員工" + user.getEmployeeName());
		...
		lblNewLabel.setBounds(10, 10, 406, 24);
		...
		panel_1.setBounds(10, 53, 426, 200);
		contentPane.add(panel_1);
		panel_1.setLayout(null);

		JButton btnNewButton =new JButton("<html>商品<br>管理</html>");
		...
		btnNewButton.setBounds(10, 10, 94, 85);
